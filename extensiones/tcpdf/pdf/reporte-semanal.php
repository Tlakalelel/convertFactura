...
extract($_POST);
$usuario=$_GET['User'];
$Direccionconsul=$_GET['dir'];
$ClaveReport=$_GET['valreport'];

//$Tema = $_GET['idPreguntaEspecifica'];
...
$DatosVistaPrevia = ControladorActividad::ControllerObtenerDatosReporteViewDownload($ClaveReport);

foreach ($DatosVistaPrevia as $key => $value) {
...
$preguntas =ControladorActividad::ControllerObtenerActividades($usuario,$Direccionconsul,$ClaveReport);
