...
if (isset($_GET['dateinireport'])&& isset($_GET['datefinreport'])) {
 
//$keyReporteView=$_GET['historyreport'];
//$keyReporteDir=$_GET['keyDir'];
  $FechaInicio=$_GET['dateinireport'];
  $FechaFinal=$_GET['datefinreport'];
...
$pdf->SetTitle('Reporte Completo Oficialia');
...
$ReporteCompleto = ControladorActividad::ControllerObtenerDatosReporteCompleto($FechaInicio,$FechaFinal);

foreach ($ReporteCompleto as $key => $value) {



            $KeyReportEnlace=$value["Clave_Reporte"];
...
$bloque2 = <<<EOF
  ...
  <table>
  <tr>
  <td width="155" id="medium" align="center" bgcolor="#DCDCDC" rowspan="2"><b><div style="top:6px">TEMA</div></b></td>
  <td width="81" id="medium" align="center" bgcolor="#DCDCDC" rowspan="2"><b><div style="top:6px">CANTIDAD</div></b></td>
  <td width="157" id="medium" align="center" bgcolor="#DCDCDC"><b>ACTIVIDAD</b></td>
  <td width="157" id="medium" align="center" bgcolor="#DCDCDC" rowspan="2"><b>INSTITUCIONES INVOLUCRADAS</b></td>
 </tr>
...
$actividadesreporte =ControladorActividad::ControllerObtenerReporteCompleto($KeyReportEnlace);
...
if (isset($_GET['downloadinicio']) && isset($_GET['downloadFin'])) {

$FechaInicio=$_GET['downloadinicio'];
  $FechaFinal=$_GET['downloadFin'];
